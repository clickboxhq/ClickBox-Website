              ...
              <div key={link.label} className="relative" role="listitem">
                ...
                {active && (
                  <motion.span
                    ...
                    className="absolute -bottom-[18px] left-1/2 h-0.5 w-4 -translate-x-1/2 rounded-full bg-primary"
          ...
          >
            <div className="px-6 pb-6 pt-3 space-y-0.5">
              ...
              <motion.div
                initial={{ opacity: 0, x: -12 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ delay: navLinks.length * 0.04, duration: 0.2, ease: "easeOut" }}
                className="pt-3"
              >
                <Link
                  to="/internship"
                  onClick={() => setMobileOpen(false)}
                  className={`flex items-center justify-center ${fellowshipBtn} w-full`}
                >
                  Fellowship
                </Link>
              </motion.div>

      ...
      <section className="section-padding border-b border-white/5 pt-32">
        <div className="mx-auto max-w-7xl">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              <div className="badge-accent-frame mb-6 inline-block rounded-full bg-[#000000] px-4 py-1.5 text-xs font-semibold uppercase tracking-wider text-foreground">
                PhishBox Ai
              </div>
              ...
              <p className="mt-4 text-sm font-medium text-[#FFFFFF]">
